...
const WorksPage = async () => {
  ...
  return (
    <React.Fragment>
      <section className="py-24 overflow-hidden sm:py-24 sm:h-screen sm:max-h-screen relative w-full justify-center flex items-center bg-black">
      ...
      <section
        id="section"
        className="py-24 sm:h-fit relative w-full justify-center flex flex-col items-center bg-black"
      >
        {Content.map((project: ProjectType, index: number) => {
          ...
          return (
            <div
              key={index}
              className={clsx(
                "sticky overflow-hidden top-0 sm:h-[75vh] pb-24 shrink-0 w-full",
                index % 2 == 0 ? "bg-white text-black" : "bg-black text-white"
              )}
            >
              <div id="container" className=" px-6 sm:px-24 w-full h-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 py-6 px-6 border-b-black">
                  <div className="">
