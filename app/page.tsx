        ...
        <div data-comp="container" className="sm:mx-auto px-base h-full">
          <div data-comp="hero" className="flex flex-col h-full">
            <div className="gap-base h-fit grid-cols-1 sm:grid-cols-4 grid">
              <div className=" sm:col-span-3 h-fit text-center flex justify-center items-center flex-col border border-bruno-pink">
                <h1 className="font-bebas text-fluid-display-2xl leading-normal">
                  Bruno Truong
                </h1>
              </div>
              <div className="sm:col-span-1 h-full bg-bruno-pink text-bruno-white flex justify-center items-center font-bold text-fluid-body-lg">
                <div className="">
                  <p>
            ...
            <div className="sm:col-span-4 py-base my-base flex sm:h-fit justify-center items-center  bg-bruno-pink text-fluid-body-xxl font-bebas text-bruno-white col-span-1">
            ...
            <div className=" gap-base col-span-1 sm:col-span-4 grow grid grid-cols-1 sm:grid-cols-4">
              ...
              <div className="sm:col-span-3 border-2 p-3 border-bruno-pink w-full">
                    ...
                    hero.projects.map((project, index) => {
                      return (
                        ...
                        >
                          ...
                          />
                          <h3 className="project_tilte ml-3 duration-500 relative z-10 text-start font-bebas text-fluid-body-xxl text-bruno-pink">
                            {projectTitle === project.projectTitle
                              ? project.projectTitle
                              : ""}
                          </h3>
