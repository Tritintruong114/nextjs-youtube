      ...
      <div data-comp="container" className="sm:mx-auto px-base h-full">
        <div className="grid sm:grid-cols-2 h-full">
          <div className="my-auto h-full col-span-1 flex justify-center items-center">
            <h2 className="text-fluid-display-xl font-bebas overflow-hidden text-center flex items-center justify-center flex-col leading-none">
              Let's bring your ideas into
              <div className="font-bold my-base w-1/2 overflow-hidden font-manrope text-bruno-yellow bg-bruno-dark-grey">
        ...
        <div className="border-t border-bruno-black py-base flex justify-between items-center">
          <div>
          ...
          <div className="flex justify-center items-center gap-base">
            ...
            <p className="font-bebas text-fluid-body-xl leading-none">
              Bruno Truong
            </p>
            <p>
              <svg
