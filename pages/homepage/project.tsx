      ...
      <div data-comp="container" className="sm:mx-auto px-base h-full">
        <div className="grid h-full">
          ...
          <div className="grid w-full h-full py-base">
            <div className="flex gap-base sm:gap-0 flex-col sm:flex-row h-[450px] relative  justify-center items-center -mb-1">
              <div className="sm:w-1/2 h-full flex items-end  relative group hover:w-full duration-300 grayscale hover:grayscale-0">
                <Image
                  src="/images/crypto.jpg"
                  alt="Crypto"
                  height={450}
                  width={450}
                  className="w-full h-full object-cover group-hover:rounded-3xl duration-300 group-hover:border group-hover:border-bruno-yellow"
                />
              ...
              <div className="sm:w-1/2 group h-full hover:w-full duration-300 grayscale hover:grayscale-0">
                <Image
